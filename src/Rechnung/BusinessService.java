...
public class BusinessService {
    ...
    private static final String SQL_QUERY_WITH_ID = "SELECT decrypt_password, reference_text, salt FROM security WHERE id  = ?";
    private static final String SQL_QUERY = "SELECT decrypt_password, reference_text, salt FROM security";
